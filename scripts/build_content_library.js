...
//
// ALL NINE TYPES. Transcribed from the nine source documents in Drive folder
// 123a0BtPaFyhh-HbEZbRa3EN5fcg3KT8d ("InsightOut Client Report Type Content - Updated 9/4/26"),
// recorded by ID in design spec section 7.4. Not hand-written: generated by
// scripts/spike/parse_explore_docs.js, which keys on (section, zone), hard-stops at the
// END OF CONTENT sentinel, reads the type from each document's `type: N` line, and applies
// the same quote transform _v3Straighten applies at render.
//
// THE LIBRARY IS THE SOURCE MODULO THAT TRANSFORM, not a byte copy. The documents export
// curly apostrophes; everything stored here is straight, matching what the four
// already-shipped types carried. Section 7.4 records this.
//
// Verified: 150 of the 160 leaves for the four previously-built types (1, 4, 7, 9) are
// byte-identical to what shipped, and the ten that differ are the ten known corrections made
// in source — nothing unexplained. See docs/audit_pr3e_source_rebuild_v2.md.
//
...
const INTERIM_EXPLORE_V3 = {
  1: {
    ...
    p7: {
      ...
      signs: [
        ...
        "You're reworking something already finished.",
      ],
      interrupt: [
        'Try replacing "should" with "what if?".',
        "Get curious about what's annoying you.",
        'Trust you can correct it after it ships.',
      ],
    },
  },
  2: {
    p6: {
      core_motivation: 'To be loved, connected, and indispensable to the people that matter to you.',
      worldview: "The world is a place where love and worth are given to those who put others' needs above their own.",
      core_belief: "You'll be loved if you put others' needs before your own and dedicate yourself to meeting them.",
      glance: [
        'To feel appreciated, needed, and deeply connected to others.',
        "Other people's needs and feelings and the quality of connection between you.",
        'Your own needs, being seen as needy, and feeling useless to others.',
        'Sadness at the loss of connection, leading to an inflated or deflated sense of self.',
      ],
      patterns: [
        'Your mind is constantly scanning for and anticipating what others need and how meeting those needs will strengthen your standing with them. You often know what people need before they do.',
        "Few people read emotion as well as you do. There's real pride in knowing what people need and meeting it — and real resentment when your own needs, set aside and unspoken, go unmet.",
        'Your energy goes toward supporting others — orchestrating tasks, being a confidant, giving advice. When secure, you can let others support you for a change.',
      ],
    },
    p7: {
      best: [
        { title: 'Warmth', body: '— People feel seen and embraced by you and they can tell you care about them.' },
        { title: 'Anticipation', body: "— You're three steps ahead when it comes to knowing what people need." },
        { title: 'Connection', body: '— You easily relate to others and build trust and rapport quickly.' },
      ],
      edge: [
        { title: 'Overcommitting', body: '— You have a much easier time saying "yes" than saying "no".' },
        { title: 'Intrusive', body: "— Your anticipation can show up as help that wasn't asked for or wanted." },
        { title: 'Resentment', body: '— Hurt builds over needs you never named and no one anticipated.' },
      ],
      styles: [
        {
          name: 'Warm and Personal',
          bullets: [
            "You lead with warmth and encouragement, and there's a sweetness to your tone of voice.",
            'You are indirect when communicating what you need, leaving others to "get it".',
            'You offer praise and acknowledgement as a way of building connection.',
          ],
        },
        {
          name: 'Protect the Relationship',
          bullets: [
            'You move toward the other person in conflict to protect your connection.',
            'You reframe smaller skirmishes into positive alternatives or ways forward.',
            'When pushed hard, warmth goes out the door, making you demanding and forceful.',
          ],
        },
        {
          name: 'Who Does This Affect',
          bullets: [
            'You weigh decisions by how they will positively or negatively impact the relationship.',
            'You scan for emotional resonance in the room when making decisions as a group.',
            "You're more comfortable supporting other decision-makers than taking the lead.",
          ],
        },
      ],
      signs: [
        "You're positive that your help is the right help.",
        "You're sad that what you need is being ignored.",
        'You\'re saying "yes" when you want to say "no".',
      ],
      interrupt: [
        'Check in with the other person to make sure.',
        'Get clear on what you need and ask for it directly.',
        'Say yes to less so the yes means more.',
      ],
    },
  },
  3: {
    p6: {
      core_motivation: 'To be recognized, respected, and admired for getting things done and achieving your goals.',
      worldview: 'The world is a place where performance, results, and image matter deeply and are rewarded.',
      core_belief: "You'll be loved and deemed worthy if you succeed and present a winning image. You are what you achieve.",
      glance: [
        'To feel admired, valued, and seen as successful.',
        "Goals, tasks, results, and how you're being perceived.",
        'Failure, disapproval, and feelings that waste time and energy.',
        'Sadness at the thought that without your achievements, you might not be lovable.',
      ],
      patterns: [
        "Your mind is quick, strategic, and outcome-focused. It tracks what's left to be done and how you're coming across while you do it. You over-identify with your work until it defines who you are.",
        'You see feelings, especially sadness and fear, as inefficient and rarely make time to process them. You project positivity outwardly, and use anger and frustration as fuel for getting things done.',
        "You move fast and deliver, adapting your presentation to match what you think the room wants. Your competitiveness draws you to winnable activities. In flow, the team's win matters more than your own.",
      ],
    },
    p7: {
      best: [
        { title: 'Drive', body: '— You set a goal, line up the tasks, and deliver faster than anyone expects.' },
        { title: 'Adaptability', body: '— You size up a situation and pivot quickly, without losing momentum.' },
        { title: 'Inspiring', body: '— You easily enroll others into taking on seemingly intractable challenges.' },
      ],
      edge: [
      ...
      styles: [
        {
          name: 'Polished and Persuasive',
          bullets: [
            "You're clear, efficient, and direct, getting to the point faster than most people.",
            'You adjust your delivery to the room, and the adjustment is usually seamless.',
            'You exude confidence, making others stand a little taller than they otherwise would.',
          ],
        },
        {
          name: 'Solve It and Move On',
          bullets: [
            'You move readily into conflict, often dispassionately and rationally.',
            'You treat conflict as a problem to be solved through competence, not compassion.',
            'Under real pressure, you disengage, and the drive diffuses into busy-ness.',
          ],
        },
        {
          name: 'Speed Over Certainty',
          bullets: [
            'You decide fast, confident that you can always course-correct later on.',
            "You sometimes take shortcuts to speed up delivery and it works — until it doesn't.",
            "You rarely allow feelings — yours or others' — to influence your decision-making.",
          ],
        },
      ],
      signs: [
        "You're already calculating the hit to your image.",
        "You're exhausted and pushing through it.",
        "You're ending tough conversations too quickly.",
      ],
      interrupt: [
        "What would you do if image wasn't at stake?",
        'Remember: you have to go slow to go fast.',
        'Do nothing but listen and be curious.',
      ],
    },
  },
  4: {
      ...
      styles: [
        ...
        },
        {
          ...
          bullets: [
            ...
            'Decisions must align with your personal purpose, identity, and values to feel right.',
  ...
  5: {
    p6: {
      core_motivation: 'To guard your inner resources, be competent, and maintain your self-sufficiency.',
      worldview: 'The world is an intrusive place that demands too much from you and gives little back in return.',
      core_belief: "If you protect your energy, gather knowledge, and keep your needs small, you'll be safe.",
      glance: [
        'To feel secure, with enough knowledge, resources, and space.',
        'Potential intrusion, demands on your energy, and the next important thing to know.',
        "Intrusion, depletion, and incompetence — yours and other people's.",
        'Fear of intrusion and depletion, which leads you to hold back what you have — including yourself.',
      ],
      patterns: [
        "You're naturally cerebral, with a hunger for knowledge and understanding that's both deep and wide. You keep strong boundaries by compartmentalizing information, people, and circumstances in your mind.",
        'You protect yourself from being emotionally drained by delaying or intellectualizing your feelings. You often experience and process feelings hours or days after the fact, but rarely in the moment.',
        'You enjoy your alone time, retreating to your cave and playing with your intellectual tinker toys. When secure, you act decisively, with more confidence and presence than people expect.',
      ],
    },
    p7: {
      best: [
        { title: 'Clarity', body: '— You cut through noise, and people know exactly where you stand.' },
        { title: 'Depth', body: "— You've clearly done your research as you speak with a level of understanding few reach." },
        { title: 'Composure', body: '— You stay calm and clear-headed where most people would come undone.' },
      ],
      edge: [
      ...
      styles: [
        {
          name: 'Precise and Sparing',
          bullets: [
            'You conserve your words, and the ones you do use are almost always worth the wait.',
            'You have no patience for chit-chat; you value intellectually stimulating conversations.',
            'You rarely express your emotions outwardly, leaving people unsure of how you really feel.',
          ],
        },
        {
          name: 'Facts Over Feelings',
          bullets: [
            'Your first urge is to withdraw so you can think it through before you engage.',
            'You argue from facts and evidence, dismissing emotionally-based assertions.',
            'Your objectivity in conflict can be mistaken for coldness or aloofness.',
          ],
        },
        {
          name: 'Know Before Deciding',
          bullets: [
            "You want to understand a decision from all angles before you'll commit to it.",
            "Decisions need to be supported with evidence and facts; gut feelings won't suffice.",
            'The cost to your energy and resources is integral to your decision-making process.',
          ],
        },
      ],
      signs: [
        "You're stuck in analysis paralysis.",
        'A past experience is starting to hurt.',
        "You're spending a lot of time alone.",
      ],
      interrupt: [
        'Run things by someone you trust.',
        'Stay with it 10 minutes longer than you would.',
        'Go where people are; engaging is optional.',
      ],
    },
  },
  6: {
    p6: {
      core_motivation: 'To feel safe, have contingencies, and find people you can truly rely on.',
      worldview: 'The world is a dangerous, unpredictable, and untrustworthy place.',
      core_belief: "You'll be safe if you stay vigilant, know where the exits are, and know who has your back.",
      glance: [
        'To feel steady and certain, and to be confident the group is okay.',
        "What could go wrong, who can be trusted, and what's really happening behind the scenes.",
        'Unmanaged risk, blindly trusting authority, and being unsupported.',
        'Anxiety that simmers under the surface, certain it will find something to attach to.',
      ],
      patterns: [
        "Your mind questions everything, including itself. The doubt protects you, and it also turns on your own judgment. It's why you catch what others walk straight into.",
        'The underlying anxiety shows up as nervousness, skepticism, and sometimes panic. You project your feelings onto others to diffuse the unease. Ease is available, but you rarely settle into it.',
        "The pattern emerges two ways: phobic, where caution rules, or counterphobic, where you meet fear head-on. Either way you're responsible and loyal. In flow, you're okay with not being okay.",
      ],
    },
    p7: {
      best: [
        { title: 'Preparedness', body: "— You've thought through the problem before anyone else has noticed it." },
        { title: 'Loyalty', body: '— Your dedication to the well-being of the group inspires cohesion and collaboration.' },
        { title: 'Steadiness', body: "— When it actually goes wrong, you're the calmest person in the room." },
      ],
      edge: [
      ...
      styles: [
        {
          name: 'Careful and Questioning',
          bullets: [
            "You're thoughtful, inquisitive, and engaging, especially with people you trust.",
            'You ask the questions others might avoid, and you press for evidence.',
            'Others may perceive you as pessimistic, contrary, and challenging.',
          ],
        },
        {
          name: 'Brace and Engage',
          bullets: [
            'You move towards engagement, especially when you perceive the conflict as a debate.',
            'You either seek to appease or move against, sometimes both in one conversation.',
            'You can bring volume and intensity to an argument, especially when safety is at stake.',
          ],
        },
        {
          name: 'Check and Double-Check',
          bullets: [
            "You want the downside mapped out before you'll commit to the upside.",
            "You'll seek input and reassurance from people you trust, repeatedly.",
            'You doubt your own judgment, looking outside yourself for answers.',
          ],
        },
      ],
      signs: [
        "You're looping worst-case scenarios.",
        "You're feeling the off-balance buzz of anxiety.",
        "You're looking outside yourself for answers.",
      ],
      interrupt: [
        "Imagine what you want, not what you don't want.",
        'Pause, breathe, and move your body.',
        'Ask "what can I trust in myself?"',
      ],
    },
  },
  7: {
    ...
    p7: {
      ...
      edge: [
        ...
        { title: 'Positivity Overload', body: '— Sometimes the room needs to feel the weight of the moment.' },
  ...
  8: {
    p6: {
      core_motivation: "To be strong, stay free of anyone's control, and protect what matters to you.",
      worldview: 'The world is an unjust place where the powerful take advantage of others.',
      core_belief: "If you project strength and hide your vulnerabilities, you'll be in control of your world.",
      glance: [
        'To feel powerful, respected, and beholden to no one.',
        'Unfair advantages, misuse of power, and situations nobody is taking charge of.',
        "Vulnerability, dependence, and being under anyone's control.",
        'Anger that powers you up, hardens you, and goes outward as force.',
      ],
      patterns: [
        'Your mind is a built-in spin detector, and you can tell when someone is hedging or posturing. You sort reasonable uses of power from harmful ones, and people into good guys and bad guys.',
        'You tend to be quick to anger, and once expressed it dissipates quickly. Vulnerable feelings like fear and sadness are felt but shielded from others. Love is expressed through strength and protection.',
        'You act on gut instinct, moving quickly and decisively, especially when justice or control is at stake. At your best you demonstrate caring concern for others. When activated, a tornado gets released.',
      ],
    },
    p7: {
      best: [
        { title: 'Courage', body: '— You are not afraid to stand up for what you believe to be fair and just.' },
        { title: 'Advocacy', body: "— When someone close to you needs defending, you're already on your feet." },
        { title: 'Straight Talk', body: '— People know where they stand with you and are never left guessing.' },
      ],
      edge: [
      ...
      styles: [
        {
          ...
          bullets: [
            'You are direct and speak with confidence and authority, leaving little room for dissent.',
            '"Be brief, be brilliant, and be gone" is how you expect others to communicate with you.',
            'You communicate with passion and energy, even at lower volume levels.',
          ],
        },
        {
          name: 'Into the Fire',
          bullets: [
            'Conflict is a contact sport and you move directly and decisively into it.',
            "You'll say the hard thing to anyone, with a conviction that's hard to ignore.",
            'The same energy that makes you a strong communicator can be overwhelming in conflict.',
          ],
        },
        {
          name: 'Decide and Move',
          bullets: [
            "You decide fast, from the gut, and you'd rather correct course than delay action.",
            "You're open to deliberation as long as people are willing to stand toe-to-toe with you.",
            "Once you've decided, changing your mind is like trying to move a mountain.",
          ],
        },
      ],
      signs: [
        'You already have the right answer or decision.',
        'You feel yourself powering up to move against.',
        'The room has suddenly gone quiet around you.',
      ],
      interrupt: [
        'Ask yourself "what could I be missing?"',
        "Explore what's at stake underneath the surge.",
        "Get curious about what's happening — and listen.",
      ],
    },
  },
  9: {
    ...
    p7: {
      ...
      signs: [
        "Your opinion is formed and you're not saying it.",
        'You ignore the tension in your body.',
        "You're busy with everything but the hard thing.",
      ],
      interrupt: [
        'Tell yourself your perspective matters here.',
